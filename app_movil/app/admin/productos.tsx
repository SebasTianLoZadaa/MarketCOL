...
function ProductosHeader({
    ...
    setFiltroCategoria,
    fetchProductos
}: ProductosHeaderProps, Readonly) {
    return (
        <>
            {canManageProductos && (
                <Pressable
                    style={styles.createBtn}
                    onPress={() => push('/admin/producto-form')}
                >
                    <Ionicons
            ...
            >
                <Pressable
                    ...
                    style={[
                        styles.chip,
                        filtroCategoria === '' && styles.chipActive
                    ]}
                >
                    <ThemedText
                        style={[
...
export default function AdminProductosScreen() {
    ...
    const canManageProductos =
        isAdmin || user?.rol === 'auxiliar';

    useEffect(() => {
        // Cargar categorías para los filtros
        apiClient
            .get('/admin/categorias?activo=true')
            .then(res =>
                setCategorias(
                    res.data?.data?.categorias || []
                )
            )
            .catch(() => {});
    }, []);
                                    ...
                                    {isAdmin && (
                                        <Pressable
                                            ...
                                            onPress={() => {
                                                Alert.alert(
                                                    'Eliminar producto',
                                                    'no se puede eliminar producto, ingresa desde la página web'
                                                );
                                            }}
                                        >
                                            <Ionicons

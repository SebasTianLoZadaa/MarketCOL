    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <ThemedView style={styles.card}>
          ...
          <View style={styles.detailRow}>
            ...
            <ThemedText style={styles.detailValue}>
              {pedido.metodoPago === 'whatsapp' ? (
                ...
                <><Ionicons name="cash-outline" size={14} color="#B01F1F" /> Efectivo</>
              )}
            </ThemedText>
          </View>
          ...
          <View style={styles.detailRow}>
            ...
            <ThemedText style={styles.detailValueVerde}>
              <Ionicons name="storefront-outline" size={14} color="#D92B2B" /> Aliste y recoja
            </ThemedText>
          </View>
      ...
      {pedidoListo && (
        <View style={styles.alertaListo}>
          <Ionicons name="checkmark-circle" size={24} color="#D92B2B" />
...
const styles = StyleSheet.create({
  ...
  banner: { 
    borderRadius: 16, padding: 24, backgroundColor: '#D92B2B', 
    alignItems: 'center', gap: 10 
  },
  bannerTitle: { color: '#fff', fontSize: 24 },
  bannerText: { color: '#fee2e2', textAlign: 'center', fontSize: 14, lineHeight: 20 },
  card: {
  ...
  detailValueVerde: { fontWeight: '500', fontSize: 13, color: '#D92B2B' },
  separator: { height: 1, backgroundColor: '#e8e8e8' },
  total: { fontSize: 20, fontWeight: '800', color: '#D92B2B', textAlign: 'right' },
  alertaListo: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: '#fee2e2', borderRadius: 10, padding: 14,
  },
  alertaListoText: { flex: 1, color: '#7f1d1d', fontWeight: '600', fontSize: 14 },
  whatsappButton: {
  ...
  secondaryButton: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    borderRadius: 10, borderWidth: 1.5, borderColor: '#D92B2B',
    paddingVertical: 14,
  },
  secondaryButtonText: { color: '#D92B2B', fontWeight: '600', fontSize: 16 },

...
const Sidebar = () => {
  ...
  return (
    <div
      className="bg-dark text-white vh-100 p-3 position-sticky top-0"
    ...
    >
      ...
      <Nav className="flex-column mt-3">
        ...
        <div className="text-muted small text-uppercase mt-3 mb-1 px-2">
          Catálogo
        </div>
        ...
        <Nav.Link
          ...
          to="/admin/categorias"
          className={`text-white mb-1 rounded ${
            isActive('/admin/categorias') ? 'bg-primary' : ''
          }`}
        >
        ...
        <Nav.Link
          ...
          className={`text-white mb-1 rounded ${
            isActive('/admin/subcategorias') ? 'bg-primary' : ''
          }`}
        >
        ...
        <Nav.Link
          ...
          to="/admin/productos"
          className={`text-white mb-1 rounded ${
            isActive('/admin/productos') ? 'bg-primary' : ''
          }`}
        >
        ...
        <Nav.Link
          ...
          className={`text-white mb-1 rounded ${
            isActive('/admin/proveedores') ? 'bg-primary' : ''
          }`}
        >
        ...
        <Nav.Link
          ...
          to="/admin/pedidos"
          className={`text-white mb-1 rounded ${
            isActive('/admin/pedidos') ? 'bg-primary' : ''
          }`}
        >
        ...
        {isAdmin && (
          <>
            ...
            <Nav.Link
              ...
              to="/admin/usuarios"
              className={`text-white mb-1 rounded ${
                isActive('/admin/usuarios') ? 'bg-primary' : ''
              }`}
            >
